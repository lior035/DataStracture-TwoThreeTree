...
{
    //In case that no filename commend line argumennt provided by the user - print error and exit
    if (argc <= 1)
    {
        cout << "Note! : " << argv[0] << " <Filename>" << endl;
        exit(1);
    }
 
   
	string outputFile;
	char *pNameOfFile = argv[1];
